...
#
# Generate Twisted cache
    su - cowrie -c "export PYTHONPATH=/home/cowrie/cowrie:/home/cowrie/cowrie/src && \
        cd /home/cowrie/cowrie && \
        timeout 10 /usr/bin/twistd --uid=2000 --gid=2000 -y cowrie.tac --pidfile cowrie.pid cowrie || true" && \
    rm -f /home/cowrie/cowrie/cowrie.pid && \
...
# Cleanup
    apk del --purge \
        ...
        python3-dev \
        py3-mysqlclient && \
    rm -rf /root/* /tmp/* /var/cache/apk/* /home/cowrie/cowrie/.git
